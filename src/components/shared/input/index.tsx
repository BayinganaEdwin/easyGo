...
const typeClasses: Record<string, string> = {
  ...
  secondary: 'border-primary focus:border-secondary focus:ring-secondary text-secondary',
...
const Input: FC<CustomInputProps> = ({
  ...
  const prefixWithSpacing = addonBefore ? <span className="mr-2.5">{addonBefore}</span> : null;
