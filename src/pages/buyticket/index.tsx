...
const Payment: NextPageWithLayout = () => {
  ...
  return (
    <Fragment>
      ...
      <Flex vertical className="bg-gray-100 h-screen">
        <Flex justify="space-between" className="items-center p-2">
          <Typography variant="header">easyGo.</Typography>
          <Flex
            justify="center"
            className="w-10 h-10
          items-center rounded-full bg-purple-700 text-white text-lg font-semibold
          shadow-sm cursor-pointer p-2">
            M
          </Flex>
        </Flex>

        <Flex className="">
          <Flex justify="flex-end" className="w-full text-black bg-gray-100 rounded-3xl">
            <Flex justify="flex-end">
              <Flex
                vertical
                className=" hover:shadow-md rounded-xl w-[100%] ml-6 mt-6 mb-6 p-4 gap-4 bg-slate-50 ">
            ...
            <Flex vertical className="w-[50%] mt-6 p-4 gap-4 font-sans">
